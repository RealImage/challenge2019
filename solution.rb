...
class Challenge2019
  def solution1
    ...
    write_output("output_pr.csv", output)
    output
  end
  ...
  def solution2
    ...
    possible_array = get_capacity(combination(total_cost))
    output_array = []
    index = 0
    deliveries.each do |delivery|
    ...
    write_output("output_pr2.csv", output_array)
    output_array
  end

  def combination(total_cost)
    combinations = []
  ...
  def get_capacity(combination_array)
